...
urlpatterns = [
    ...
    path('xiumi/image/', views.xiumi_upload_image, name='xiumi-image'),
    path('xiumi/article/', views.xiumi_receive_article, name='xiumi-article'),
    path('xiumi/notify/', views.xiumi_notify, name='xiumi-notify'),
