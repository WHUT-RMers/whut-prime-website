...
<style scoped>
.email-verify{display:grid;gap:10px;padding:13px 14px;border:1px solid rgba(45,226,166,.26);border-radius:8px;background:rgba(45,226,166,.04)}
.email-verify p{margin:0;color:var(--ink-dim);font-size:.82rem}.email-verify>div{display:flex;gap:9px;align-items:center}.email-verify input{min-height:40px;max-width:140px;padding:8px 10px}.email-verify .btn{min-height:40px;padding:0 12px;white-space:nowrap}.email-verify small.verified{color:var(--accent)}
.email-verify small.is-error{color:var(--accent-warm)}.attachment-field{display:grid;gap:9px;color:var(--ink-dim);font-size:.9rem}.file-picker{position:relative;display:flex;align-items:center;justify-content:center;min-height:54px;border:1px dashed rgba(45,226,166,.45);border-radius:8px;background:rgba(45,226,166,.035);color:var(--accent);cursor:pointer;transition:.18s ease}.file-picker:hover{border-color:var(--accent);background:rgba(45,226,166,.08)}.file-picker input{position:absolute;inset:0;width:100%;min-height:0;opacity:0;cursor:pointer}.file-picker strong{font-size:.9rem}
...
@media(max-width:620px){.email-verify>div{flex-wrap:wrap}.email-verify input{max-width:none;flex:1 1 130px}.existing-application dl{grid-template-columns:1fr}}
</style>
