...
.summary{max-width:720px;margin-top:20px;color:var(--ink-dim);font-size:clamp(1rem,.4vw + .96rem,1.08rem);line-height:1.82;text-wrap:pretty}
...
.hero>figcaption{padding:10px 4px 0;color:var(--ink-faint);font-size:13px;line-height:1.65;text-align:center}
...
.article-body{color:var(--ink-dim);font-size:clamp(1rem,.2vw + .98rem,1.07rem);line-height:1.98;word-break:break-word;overflow-wrap:anywhere}
...
.article-body :deep(h3){margin:2em 0 .68em;color:var(--ink);font-size:clamp(1.17rem,1.8vw,1.34rem);line-height:1.48}
...
.article-body :deep(blockquote){margin:2em 0;padding:.65em 1.3em;border-left:3px solid var(--accent);background:rgba(45,226,166,.055);color:var(--ink-dim)}
.article-body :deep(a){color:var(--accent);text-decoration:underline;text-decoration-thickness:1px;text-underline-offset:4px}
.article-body :deep(strong){color:var(--ink);font-weight:700}
...
.article-body :deep(figure img){display:block;width:100%;height:auto;max-height:min(76vh,760px);object-fit:contain;border:1px solid var(--line-strong);border-radius:6px;background:var(--bg)}
.article-body :deep(figcaption){padding:10px 4px 0;color:var(--ink-faint);font-size:13px;line-height:1.65;text-align:center;background:transparent}
